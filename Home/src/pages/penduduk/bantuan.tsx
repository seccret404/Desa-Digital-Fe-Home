...
export default function BantuanPage() {
  ...
  return (
    <div className="bg-[#F8F2F2]">
      <Layout>
        <div className="bg-gradient-to-r from-orange-500 to-orange-900 text-white text-[20px] p-2 rounded-[5px] md:ml-[56px] md:mr-[56px] m-2 mt-[27px]">Statistik Penduduk  - Bantuan</div>
        <div className="bg-white p-4 rounded-[8px] md:ml-[56px] md:mr-[56px] m-2 mt-4">
          ...
          <div className="flex flex-wrap justify-between md:ml-[100px] md:mr-[100px] mt-8">
            <div>
              <div className="bg-[#E9871D] w-[200px] rounded-[7px] mt-4 md:ml-[50px]">
            ...
            <div>
              ...
              <Table className='border border-2 border-[#525252] md:w-[450px]' style={{ borderRadius: '5px' }}>
          ...
          <div className="flex flex-wrap justify-between md:ml-[100px] md:mr-[100px] mt-8">
            <div>
              ...
              <PieChart width={350} height={300} margin={{ top: 20, right: 0, left: -110, bottom: 5 }}>
                <Pie
                  data={dataDesa}
                  cx={200}
                  cy={100}
