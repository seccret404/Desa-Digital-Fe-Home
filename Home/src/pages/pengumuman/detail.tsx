            ...
            <div>
              ...
              {pengumuman.cover_pengumuman && typeof pengumuman.cover_pengumuman === 'string' && (
                pengumuman.cover_pengumuman.endsWith('.jpg') || pengumuman.cover_pengumuman.endsWith('.png') || pengumuman.cover_pengumuman.endsWith('.jpeg') ? (
                  <img src={`https://desa-api.desajanggadolok.id/api/pengumuman_cover/${pengumuman.cover_pengumuman}`} alt="Cover Pengumuman" className="w-full h-auto" />
                ) : pengumuman.cover_pengumuman.endsWith('.pdf') ? (
                  <a href={`https://desa-api.desajanggadolok.id/api/pengumuman_cover/${pengumuman.cover_pengumuman}`} target="_blank" rel="noopener noreferrer" className="bg-[#D40F0F] p-2 rounded-[5px] text-[white]">Download PDF</a>
                ) : (
                  <a href={`https://desa-api.desajanggadolok.id/api/pengumuman_cover/${pengumuman.cover_pengumuman}`} target="_blank" rel="noopener noreferrer">{pengumuman.cover_pengumuman}</a>
                )
              )}
            </div>
            </div>
